from numpy import asarray, delete, vstack, insert, array, mat, loadtxt, zeros, exp, multiply, sum, square, sqrt, hstack, unique, ones, argmax, power, argmin
...
n_epoch = 200
n_fold = 10
learning_rate_W_zy = 1e-3
learning_rate_center = 1e-3
learning_rate_spread = 1e-3
